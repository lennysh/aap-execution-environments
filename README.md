...
| `ee-proxmox-rhel9` | Dynamic Proxmox Inventory |  | 2.17.x | RHEL 9 | [Link](vars/ansible-automation-platform/ee-proxmox-rhel9.yml) | [Link](https://quay.io/repository/lshirley/ansible-automation-platform/ee-proxmox-rhel9) |
| `ee-unifi-rhel9` | Dynamic UniFi Inventory |  | 2.17.x | RHEL 9 | [Link](vars/ansible-automation-platform/ee-unifi-rhel9.yml) | [Link](https://quay.io/repository/lshirley/ansible-automation-platform/ee-unifi-rhel9) |
